...
async def get_workflows(owner: str, repo: str, connection_id: str = "") -> ApiResponse:
    """List workflows."""
    from .tools import list_github_workflows
...
async def get_workflow_runs(
    ...
    """List workflow runs."""
    from .tools import list_github_workflow_runs
...
async def get_workflow_run(
    ...
    from .tools import get_github_workflow_run
...
async def trigger_workflow(
    ...
    """Trigger a workflow."""
    from .tools import trigger_github_workflow
...
async def cancel_workflow_run(
    ...
    from .tools import cancel_github_workflow_run
...
async def rerun_workflow(
    ...
    """Re-run a workflow."""
    from .tools import rerun_github_workflow
...
async def get_jobs(
    ...
    """List workflow jobs."""
    from .tools import list_github_jobs
...
async def get_pull_requests(
    ...
    """List pull requests."""
    from .tools import list_github_pull_requests
...
async def get_pull_request(
    ...
    from .tools import get_github_pull_request
...
async def create_pull_request(
    ...
    from .tools import create_github_pull_request
...
async def merge_pull_request(
    ...
    from .tools import merge_github_pull_request
...
async def get_issues(
    ...
    """List issues."""
    from .tools import list_github_issues
...
async def get_branches(owner: str, repo: str, connection_id: str = "") -> ApiResponse:
    """List branches."""
    from .tools import list_github_branches
...
async def get_commits(
    ...
    """List commits."""
    from .tools import list_github_commits
...
async def get_tags(owner: str, repo: str, connection_id: str = "") -> ApiResponse:
    """List tags."""
    from .tools import list_github_tags
...
async def get_releases(owner: str, repo: str, connection_id: str = "") -> ApiResponse:
    """List releases."""
    from .tools import list_github_releases
...
async def create_release(
    ...
    """Create a release."""
    from .tools import create_github_release
...
async def get_variables(owner: str, repo: str, connection_id: str = "") -> ApiResponse:
    ...
    from .tools import list_github_variables
...
async def create_variable(
    ...
    from .tools import create_github_variable
...
async def delete_variable(
    ...
    """Delete a variable."""
    from .tools import delete_github_variable
...
async def search_code(q: str, connection_id: str = "") -> ApiResponse:
    """Search code."""
    from .tools import search_github_code
...
async def search_issues(q: str, connection_id: str = "") -> ApiResponse:
    """Search issues."""
    from .tools import search_github_issues
