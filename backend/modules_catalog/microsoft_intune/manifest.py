...
module_manifest = ModuleManifest(
    ...
    dashboard_tab={
        "id": "microsoft_intune",
        "label": "Intune",
        "icon": '<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="7" y="2" width="10" height="20" rx="2"/><path d="M7 18h10"/><path d="M10 21h4"/><path d="M9 11l2 2 4-4"/></svg>',
    },
