...
async def containers(all: bool = True, connection_id: str = "") -> object:
    """List all Docker containers."""
    return await list_containers.ainvoke({"all": all, "connection_id": connection_id})


@router.get("/containers/{container_id}")
async def container_inspect(container_id: str, connection_id: str = "") -> object:
...
@router.get("/images")
async def images(all: bool = False, connection_id: str = "") -> object:
...
@router.get("/volumes")
async def volumes(connection_id: str = "") -> object:
